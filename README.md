...
![Open Issues](https://img.shields.io/github/issues/guilhermegor/fiap-global-solution-1)
...
### Installation
```bash
git clone https://github.com/guilhermegor/fiap-global-solution-1.git
cd fiap-global-solution-1
npm install
...
```bash
gh api -X POST repos/guilhermegor/fiap-global-solution-1/pages \
...
## 🔗 Useful Links
- [GitHub Repository](https://github.com/guilhermegor/fiap-global-solution-1)
- [Issue Tracker](https://github.com/guilhermegor/fiap-global-solution-1/issues)
